...
def update_projection():
    ...
    classes = ("airplane", "car", "bird", "cat", "deer", "dog", "frog", "horse", "ship", "truck")
    mms = MMS(content_path, net, 1, 200, 1, 512, 10, classes, temperature=0.1, cmap="tab10", resolution=resolution, verbose=1, attention=False,
              temporal=False, split=-1, alpha=0.1, advance_border_gen=True, withoutB=False, attack_device="cuda:0")
