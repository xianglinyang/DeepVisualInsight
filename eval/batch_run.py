...
os.system("python run.py --content_path E:\\DVI_exp_data\\resnet18_cifar10 --epoch_start 40 --epoch_end 200 --epoch_period 40 --resolution 100 --embedding_dim 512 --cuda True -a 0.6 -t 0.3 --num_class 10 --split -1 --preprocess 1 --parametricUmap 1 --temporal 2 --attention 1")
