...
# os.system("python run.py --content_path E:\\DVI_exp_data\\TemporalExp\\resnet18_emnist --epoch_start 0 --epoch_end 11 --epoch_period 1 --resolution 100 --embedding_dim 512 --cuda True -a 0.5 -t 0.02 --num_class 10 --split -1 --temporal 1 --preprocess 1")
# os.system("python run.py --content_path E:\\DVI_exp_data\\TemporalExp\\resnet18_emnist --epoch_start 0 --epoch_end 11 --epoch_period 1 --resolution 100 --embedding_dim 512 --cuda True -a 0.5 -t 0.02 --num_class 10 --split -1 --temporal 2 --preprocess 0")
os.system("python run.py --content_path E:\\DVI_exp_data\\TemporalExp\\resnet18_emnist --epoch_start 0 --epoch_end 11 --epoch_period 1 --resolution 100 --embedding_dim 512 --cuda True -a 0.5 -t 0.02 --num_class 10 --split -1 --temporal 3 --preprocess 1")
