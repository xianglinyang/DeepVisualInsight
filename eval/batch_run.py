...
os.system("python {} --content_path /home/xianglin/projects/DVI_data/TemporalExp/resnet18_mnist --epoch_start 1 --epoch_end 10 --epoch_period 1 --resolution 100 --embedding_dim 512 --cuda True -a 0.5 -t 0.02 --num_class 10 --split -1 --temporal 3 --preprocess 1".format(RUN))
#
...
os.system("python {} --content_path /home/xianglin/projects/DVI_data/TemporalExp/resnet18_fmnist --epoch_start 1 --epoch_end 11 --epoch_period 1 --resolution 100 --embedding_dim 512 --cuda True -a 0.5 -t 0.1 --num_class 10 --split -1 --temporal 3 --preprocess 1".format(RUN))
#
