...
export const template = html`
    ...
    <div class="misc-setting-editor">
        ...
        >
          ...
          <div hidden$="[[!evaluationInformationReady]]">
          <p>Projection nn perseverance knn: (train,10): <span class="nn_train_10">0.50</span> (train,15): <span class="nn_train_15">0.50</span> (train,30): <span class="nn_train_30">0.50</span> (test,10): <span class="nn_test_10">0.50</span> (test,15): <span class="nn_test_15">0.50</span> (test,30): <span class="nn_test_30">0.50</span></p>
          <p>Projection boundary perserverance knn: (train,10): <span class="bound_train_10">0.50</span> (train,15): <span class="bound_train_15">0.50</span> (train,30): <span class="bound_train_30">0.50</span> (test,10): <span class="bound_test_10">0.50</span> (test,15): <span class="bound_test_15">0.50</span> (test,30): <span class="bound_test_30">0.50</span></p>
          <p>Inverse nn perseverance knn: (train,10): <span class="inv_nn_train_10">0.50</span> (train,15): <span class="inv_nn_train_15">0.50</span> (train,30): <span class="inv_nn_train_30">0.50</span> (test,10): <span class="inv_nn_test_10">0.50</span> (test,15): <span class="inv_nn_test_15">0.50</span> (test,30): <span class="inv_nn_test_30">0.50</span></p>
          <p>Inverse accuracy: train: <span class="inv_acc_train">0.50</span> test: <span class="inv_acc_test">0.50</span></p>
          <p>Inverse confidence difference: train: <span class="inv_conf_train">0.50</span> test: <span class="inv_conf_test">0.50</span></p>
          </div>
